...
export default function DomainPage() {
  ...
  // Update input field when domain param changes
  useEffect(() => {
  ...
  // Handle domain input change (only update state, don't navigate)
  ...
  const handleSearch = () => {
    if (inputDomain.trim()) {
      router.push(`/${encodeURIComponent(inputDomain.trim())}`);
    } else {
      router.push('/');
    }
  };
          ...
          <div className="bg-gray-900 border border-green-500/30 rounded-lg p-6 shadow-2xl">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                disabled={!inputDomain.trim() || isLoading || isWhoisLoading}
            ...
            <div className="mt-3 text-xs text-gray-400">
              <span className="text-cyan-400">ANALYZING:</span> {domain}
            </div>
          </div>
        </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-800 border border-green-500/30 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        onClick={() => copyToClipboard(whoisData.registrant.email || '')}
                        title="Click to copy full email"
                      >
                        {whoisData.registrant.email 
                          ? `${whoisData.registrant.email.slice(0,3)}...${whoisData.registrant.email.slice(-3)}`
                          : ''}
                      </span>
                      </div>
                        )}
                    ...
                    <div className="bg-gray-800 border border-green-500/30 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {whoisData.admin.email && (
                          ...
                          <span 
                          className="text-cyan-400 font-mono cursor-pointer hover:text-cyan-300" 
                          onClick={() => copyToClipboard(whoisData.admin.email || '')}
                          title="Click to copy full email"
                        >
                          {whoisData.admin.email 
                            ? `${whoisData.admin.email.slice(0,3)}...${whoisData.admin.email.slice(-3)}`
                            : ''}
                        </span>
                        </div>
                        )}
                    ...
                    <div className="bg-gray-800 border border-green-500/30 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        {whoisData.tech.email && (
                          ...
                          <span 
                            className="text-cyan-400 font-mono cursor-pointer hover:text-cyan-300" 
                            onClick={() => copyToClipboard(whoisData.tech.email || '')}
                            title="Click to copy full email"
                          >
                            {whoisData.tech.email 
                              ? `${whoisData.tech.email.slice(0,3)}...${whoisData.tech.email.slice(-3)}`
                              : ''}
                          </span>
                          </div>
                        )}
